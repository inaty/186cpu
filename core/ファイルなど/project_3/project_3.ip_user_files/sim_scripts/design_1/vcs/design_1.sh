...
#
# Generated by Vivado on Sun Oct 07 01:55:40 JST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    ...
    "$ref_dir/../../../bd/design_1/ip/design_1_io_0_0/sim/design_1_io_0_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../project_3.srcs/sources_1/bd/design_1/ipshared/67d8/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    ...
    "$ref_dir/../../../bd/design_1/ip/design_1_blk_mem_gen_2_0/sim/design_1_blk_mem_gen_2_0.v" \
    "$ref_dir/../../../bd/design_1/ip/design_1_blk_mem_gen_3_0/sim/design_1_blk_mem_gen_3_0.v" \
  2>&1 | tee -a vlogan.log
