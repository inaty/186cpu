...
/*   y = (e1 == 255 && e2 != 255) ? {s1,8'd255,nzm1,m1[21:0]} :
   ...
   y = (e1 == 0xff) ? ((e2 == 0xff) ? ( (nzm2==1)? (s2<<31)|(0xff<<23)|(1<<22)|get(m2,21,0) : 
	 ...
	 ((e2 == 0xff) ? ((s2<<31)|(0xff<<23)|(nzm2<<22)|get(m2,21,0)) : ((sy<<31)|((get(ey,7,0))<<23)|get(my,22,0)));
  return y;
}
...
unsigned int flt(unsigned int x1,unsigned int x2){
  ...
  unsigned int  ce;
   ...
   v = (s1 == s2) ? ((s1 == 0) ? ((sel == 0 || (sel == 2 && ce == 0) ? 1 : 0 )) :
	 ...
	 ((s1 == 1 && (((e1<<23)|m1) != 0 || ((e2<<23)|m2) != 0)) ? 1 : 0 );
...
unsigned int ftoi(unsigned int x,unsigned int rm){
  ...
  unsigned int roundm;
   ...
   i = roundm >> d;
   round = get(i,30,0); // rm == 0 で0丸め(端数無視)、 rm == 1 で最近接丸め(絶対値四捨五入)
