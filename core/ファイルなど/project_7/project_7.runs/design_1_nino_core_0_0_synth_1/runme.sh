...
HD_PWD='/home/tansei/Desktop/cpu_jikken/project_7/project_7.runs/design_1_nino_core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_nino_core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_nino_core_0_0.tcl
