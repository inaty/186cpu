...
HD_PWD='/home/tansei/Desktop/cpu_jikken/project_5/project_5.runs/design_1_f_core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_f_core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_f_core_0_0.tcl
